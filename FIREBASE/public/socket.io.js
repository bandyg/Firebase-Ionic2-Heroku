...
function val(tp) {
	if (tp === 1) {
		...
		if(document.location.pathname !== "/emitir.html"){
			location.href = "/";
		}
	}
	if (tp === 2) {
		...
		if(document.location.pathname !== "/visualizar.html"){
			location.href = "/";
		}
	}
	if(tp == 3){
